...
component alarm_comp is
    port (
        SW_ON         : in  std_logic;  -- Vstupní spína�?
        ...
        global_disable: in  std_logic;  -- vstupní signál pro vypnutí alarmu (např. tla�?ítko)
    ...
    signal sig_hour_out : STD_LOGIC_VECTOR(4 downto 0);
     ...
     signal sig_alarm : STD_LOGIC; -- Interní alarmový signál
